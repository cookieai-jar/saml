...
func TestSigningAndValidation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			rawQuery, err = signQuery(&s, tc.requestType, rawQuery, reqString, relayState)
...
func signQuery(sp *ServiceProvider, reqT reqType, query, body, relayState string) (string, error) {
